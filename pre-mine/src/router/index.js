...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'edit',
        component: () => import('@/views/router/edit/edit'),
        name: 'Edit',
        meta: { title: '线路编辑', icon: 'route' },
        hidden: true,
        children: [
          {
            path: 'step1/:id',
            component: () => import('@/views/router/edit/step1'),
            name: 'Step1',
            hidden: true,
            meta: { title: '步骤一', icon: 'route' }
          },
          {
            path: 'step2/:id',
            component: () => import('@/views/router/edit/step2'),
            name: 'Step2',
            hidden: true,
            meta: { title: '步骤二', icon: 'route' }
          }
        ]
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        hidden: true,
        meta: { title: '订单详情', icon: 'orderList' }
      },
      {
        path: 'edit/:id',
        name: 'OrderEdit',
