<template>
  <div v-loading.fullscreen.lock="isLoadingAllDatas" class="app-container">
    ...
    <div class="block">
      <h3 class="title">{{ $route.params.id === 'add' ? '添加' : '编辑' }}排期</h3>
      <el-form ref="formSchedule" :model="formData" label-width="100px">
        ...
        <el-row style="margin-bottom: 50px; padding: 0 10px;">
          ...
          <!-- <el-table
            ...
            <el-table-column label="出发地点" align="center">
              <template slot-scope="scope">
                {{ scope.row.departureArea }}
              </template>
            </el-table-column>
            <el-table-column label="成人价格" prop="adultMarketPrice" align="center"/>
            <el-table-column label="成人市场价格" prop="adultPrice" align="center"/>
            <el-table-column label="儿童价格" prop="childPrice" align="center"/>
            <el-table-column label="儿童市场价格" prop="childMarketPrice" align="center"/>
            <el-table-column label="详细地址" prop="adress" align="center"/>
        ...
        <el-row type="flex" justify="space-between" align="center" style="padding: 0 20px; margin-top: 20px;">
          ...
          <div style="padding-top: 12px;">
            <!-- <el-input
              ...
              size="small"
              placeholder="输入退款规则名称"
              style="width: 200px; display: inline-block; margin-right: 30px;"/> -->
        ...
        <el-row style="margin-bottom: 50px; padding: 0 10px;">
          ...
          <!-- <el-table
            ...
            @current-change="handleSelectionRule">
...
<script>
import { addSchedule, getSchedule, deleteSchedule } from '@/api/schedule'
